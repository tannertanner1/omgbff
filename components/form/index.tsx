                  ...
                  <form onSubmit={methods.handleSubmit(onSubmit)} noValidate>
                    ...
                    <CardFooter className="relative flex flex-col items-center gap-4">
                      <Button
                        ...
                        variant="outline"
                        className={cn(
                          "[&[data-slot=button]]:border-primary [&[data-slot=button]]:bg-primary [&[data-slot=button]]:text-background [&[data-slot=button]]:hover:bg-background [&[data-slot=button]]:hover:text-primary mt-4 mr-2 border transition-colors duration-300 ease-in-out [&[data-slot=button]]:w-[20.5rem]"
                        )}
                        disabled={isPending}
